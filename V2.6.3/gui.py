...
# ✅ Corrige o diretório de trabalho dependendo se está em execução como .exe
if getattr(sys, 'frozen', False):
    os.chdir(os.path.dirname(sys.executable))
else:
    os.chdir(os.path.dirname(os.path.abspath(__file__)))

# ✅ Função para acessar arquivos mesmo dentro de _MEIPASS (PyInstaller)
...
def open_output_folder():
    folder = os.path.abspath(get_output_folder())  # ✅ caminho absoluto
